    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <a href="{{ route('admin.roles.deleted') }}" class="btn btn-block btn-warning text-black">Удаленные роли</a>
                </div>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <div class="input-group input-group-sm" style="width: 175px;">
                                            <form id="perPageForm" method="GET" action="{{ route('admin.roles.index') }}" class="mb-3">
                                                <label for="postsPerPage">Ролей на страницу:</label>
                                                <div class="input-group input-group-sm" style="width: 175px;">
