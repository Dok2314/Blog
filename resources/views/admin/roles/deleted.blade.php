...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Удаленные роли</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-1">
                    <a href="{{ route('admin.roles.create') }}" class="btn btn-block btn-primary">Добавить</a>
                </div>

                <div class="col-2">
                    <a href="{{ route('admin.roles.index') }}" class="btn btn-block btn-warning text-black">Вернуться к списку</a>
                </div>
                                    ...
                                    <form id="massRestoreForm" method="POST" action="{{ route('admin.roles.massRestore') }}">
                                        ...
                                        @foreach($roles as $role)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($role->deleted_at)->toDateString() }}</td>
                                                <td>
{{--                                                    <a href="{{ route('admin.categories.show', $category) }}">--}}
{{--                                                        <i class="far fa-eye"></i>--}}
{{--                                                    </a>--}}

                                                    <form action="{{ route('admin.roles.restore', $role) }}" method="POST">
                                                        @csrf
