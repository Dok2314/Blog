...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Удаленные теги</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <a href="{{ route('admin.tags.index') }}" class="btn btn-block btn-warning text-black">Вернуться к списку</a>
                </div>
...
{{--                                                    </a>--}}
                                                    ...
                                                    <form action="{{ route('admin.tags.restore', $tag) }}" method="POST">
                                                        @csrf
