    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <a href="{{ route('admin.users.deleted') }}" class="btn btn-block btn-warning text-black">Удаленные пользователи</a>
                </div>
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.users.edit', $user) }}" class="text-success">
                                                        edit
                                                    </a>
                                                </td>
                                            </tr>
